...
function voir2() {
  document.getElementById("pair2").style.filter = "blur(0)";
  document.getElementById("pair2").style.opacity = 1;
}
function voir3() {
  document.getElementById("pair3").style.filter = "blur(0)";
  document.getElementById("pair3").style.opacity = 1;
}
function display() {
